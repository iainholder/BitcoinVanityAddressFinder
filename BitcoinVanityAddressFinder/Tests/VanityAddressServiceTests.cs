...
namespace BitcoinVanityAddressFinder.Tests
{
    ...
    public class VanityAddressServiceTests
    {
        ...
        {
            Assert.IsFalse(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), false, false, false));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(address), false, false, false));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), false, false, false));
        }
        ...
        {
            Assert.False(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, false, false));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), false, true, false));
        }
        ...
        {
            Assert.IsFalse(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), false, true, false));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), false, false, true));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, false, false));
        }
        ...
        {
            Assert.IsFalse(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, false, false));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, true, false));
        }
        ...
        {
            Assert.IsFalse(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, true, false));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, false, true));
        }
        ...
        {
            Assert.IsFalse(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, false, true));
        }
        ...
        {
            Assert.IsTrue(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, true, true));
        }
        ...
        {
            Assert.IsFalse(VanityAddressService.IsDictionaryWordAddress(address, InputStringToDictionary(input), true, true, true));
        }

        private static Dictionary<string, string> InputStringToDictionary(string input)
        {
            return input.Split(new[] { ';' }, StringSplitOptions.None).ToDictionary(o => o);
        }
    }
}